        ...
        <div className="flex">
            ...
            <div className="dashboard p-3 m-3 rounded-2xl ml-64 md:ml-64 min-h-screen w-full">
                ...
                <div className="top flex justify-between">
                    ...
                    <button className="bg-gray-800 text-white p-2 rounded-lg flex gap-2">
                ...
                <div className="section-1 flex justify-evenly py-6">
                    {/* To collect */}
                    <div className="to-collect flex bg-gray-800 text-white px-6 py-5 rounded-lg">
                    ...
                    {/* To pay */}
                    <div className="to-pay flex bg-gray-800 text-white px-6 py-5 rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div className="section-2 flex justify-evenly">
                    ...
                    <div className="bars-dataset flex justify-center w-1/2">
                        <BarsDataset/>
                    </div>
                </div>
